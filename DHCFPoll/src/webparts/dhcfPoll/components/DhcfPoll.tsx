...
import { IDhcfPollWebPartProps } from '../IDhcfPollWebPartProps';
import { IWebPartContext } from '@microsoft/sp-webpart-base';
import * as strings from 'DhcfPollWebPartStrings';
import { SPSurveyService } from '../SPSurveyService';
import styles from '../DhcfPoll.module.scss';
...
export default class SimplePollWebPartHost extends React.Component<IDhcfPollWebPartProps, ISimplePollState> {
  ...
  constructor(props: IDhcfPollWebPartProps, context: IWebPartContext) {
    super(props, context);
    //Save the context
  ...
  private vote(elm?: any): void {
    ...
    if (this.state.selectedValue == null || this.state.selectedValue == '') {
      ...
      console.log("goint to vote",this.props.surveyList, this.state.questionInternalName, this.state.selectedValue)
  ...
  private loadQuestions(props: IDhcfPollWebPartProps): void {
   ...
   */
	public componentWillReceiveProps(nextProps: IDhcfPollWebPartProps): void {
    this.setState({
      resultsLoaded: false,
      results: [],      
        })   
   ...
   */
  public componentDidUpdate(prevProps: IDhcfPollWebPartProps, prevState: ISimplePollState): void {
    //his.loadQuestions();
  }
