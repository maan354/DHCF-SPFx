...
describe('UrlQueryParameterCollection tests', function () {
    var _loop_1 = function (test_1) {
        it(test_1.testName, function (done) {
            ...
            chai_1.assert.deepEqual(urlQuery.getValue('test'), index_1.TEST_UNDEFINED);
            chai_1.assert.deepEqual(urlQuery.getValues('test'), index_1.TEST_UNDEFINED);
            done();
        });
    };
    ...
    var _loop_2 = function (test_2) {
        it(test_2.testName, function (done) {
            ...
            chai_1.assert.deepEqual(urlQuery.getValue('test'), 'val');
            chai_1.assert.deepEqual(urlQuery.getValues('test'), ['val', 'val2']);
            done();
        });
    };
    ...
    it('should retrieve empty query parameters from a url string', function (done) {
        ...
        chai_1.assert.deepEqual(urlQuery.getValue('test'), '');
        chai_1.assert.deepEqual(urlQuery.getValues('test'), ['', index_1.TEST_UNDEFINED]);
        done();
    });
    it('should retrieve query parameter value with multiple = signs', function (done) {
        ...
        chai_1.assert.deepEqual(urlQuery.getValue('test'), 'a=b=c');
        chai_1.assert.deepEqual(urlQuery.getValues('test'), ['a=b=c', index_1.TEST_UNDEFINED]);
        done();
    });
    it('should return empty query parameter', function (done) {
        ...
        chai_1.assert.deepEqual(urlQuery.getValue(index_1.TEST_UNDEFINED), index_1.TEST_UNDEFINED);
        chai_1.assert.deepEqual(urlQuery.getValues(index_1.TEST_UNDEFINED), [index_1.TEST_UNDEFINED, index_1.TEST_UNDEFINED]);
        done();
    });
});
