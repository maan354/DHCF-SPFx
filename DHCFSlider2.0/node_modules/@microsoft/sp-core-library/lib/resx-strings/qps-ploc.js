define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      ...
      "invalidGuidStringError": "[!!--##***İŋváĺīđ ĢŮĮĐ šťŗĩŉğ: \"{0}\"##--!!]",
      ...
      "isEmptyStringValidateError": "[!!--##***Ťħē váĺűę ƒőř \"{0}\" mųšť ŉōŧ ƅĕ āń ēmƿŧƴ šŧŗīńģ##--!!]",
      ...
      "serviceScopeProvideServiceAfterFinishedError": "[!!--##***Čäŉŋōŧ ŗȇġįśţĕř śȅŗvįćȇ ƅĕċȁűšě ťħė šċơƥē įŝ ǻĺřȅâďŷ ƒįňĭšĥĕđ##--!!]",
