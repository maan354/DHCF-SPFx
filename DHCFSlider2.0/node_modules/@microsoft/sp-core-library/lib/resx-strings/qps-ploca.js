define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      "invalidEnvironmentTypeError": "***ĒņvıŕőņmęŋţŦȳƿĕ ĭŝ ıŉvąĺĩď",
      "invalidGuidStringError": "***Ĩńvåļıđ ĢŲĨĎ śŧřįŉĝ: \"{0}\"",
      ...
      "isEmptyStringValidateError": "***Ťĥē vȁĺũē ƒōŕ \"{0}\" mųšť ńŏţ Ƅė ąƞ ȇmƥţƴ śţŕĭŉğ",
      "invalidVersionStringError": "***Ĩŉvàłĩđ věŕŝĩőņ šţŗīƞģ: \"{0}\"",
      ...
      "serviceScopeConsumingBeforeFinished": "***Ċãńŉŏŧ ĉơŉŝūmĕ şēŗvĩĉȇś Ƅĕċäŭşě ťħȇ śćőƥě ış ńŏť ƒĭňĩšħȅď ȳęŧ",
      "serviceScopeConsumingDuringAutoCreation": "***Ĉȁŉŉơť ćơňşųmė ŝęřvįĉēş đŭŗıňġ ŜėřvĩčěŚċơƥē äųţōčŗĕåťīōň",
      "serviceScopeAlreadyFinishedError": "***Ťĥě ŠěřvıĉȇŜċơƿȅ ĩś âŀŕĕąďŷ ƒįŉīśħēď",
