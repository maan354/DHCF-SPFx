webpackJsonp974a7777_0990_4136_8fa6_95d80114c2e0_1_3_0([0],{
...
var Compare_1 = __webpack_require__(75);
var PropertyPaneDefinitions_1 = __webpack_require__(5);
var PropertyPanePage_1 = __webpack_require__(76);
var PropertyPaneTitleBar_1 = __webpack_require__(87);
var PropertyPaneFooter_1 = __webpack_require__(93);
var Strings_resx_1 = __webpack_require__(17);
var PropertyPane_module_scss_1 = __webpack_require__(74);
var PropertyPanePage_module_scss_1 = __webpack_require__(73);
var office_ui_fabric_react_1 = __webpack_require__(8);
var CanvasA11y_1 = __webpack_require__(97);
var PageDirection;
...
var styles = {
    propertyPaneTitleBarBox: 'propertyPaneTitleBarBox_50ae0471',
    propertyPaneTitleBar: 'propertyPaneTitleBar_50ae0471',
    propertyPanePageTitle: 'propertyPanePageTitle_50ae0471',
    propertyPaneClose: 'propertyPaneClose_50ae0471',
    propertyPanePageContent: 'propertyPanePageContent_50ae0471',
    propertyPanePageDescription: 'propertyPanePageDescription_50ae0471',
};
...
var styles = {
    propertyPane: 'propertyPane_3e42eabf',
    propertyPaneDescription: 'propertyPaneDescription_3e42eabf',
    propertyPaneScreenReaderOnly: 'propertyPaneScreenReaderOnly_3e42eabf',
    twoRowFooter: 'twoRowFooter_3e42eabf',
    oneRowFooter: 'oneRowFooter_3e42eabf',
    overlay: 'overlay_3e42eabf',
    spinner: 'spinner_3e42eabf',
};
exports.default = styles;
...
var React = __webpack_require__(3);
var office_ui_fabric_react_1 = __webpack_require__(8);
var PropertyPaneGroup_1 = __webpack_require__(77);
var PropertyPanePage_module_scss_1 = __webpack_require__(73);
...
var PropertyPaneCustomFieldHost_1 = __webpack_require__(78);
var IPropertyPaneField_1 = __webpack_require__(2);
var PropertyPaneGroup_module_scss_1 = __webpack_require__(79);
var Strings_resx_1 = __webpack_require__(17);
var PropertyPaneChoiceGroup_module_scss_1 = __webpack_require__(82);
...
var styles = {
    propertyPaneGroupHeader: 'propertyPaneGroupHeader_e4a3d54d',
    propertyPaneGroup: 'propertyPaneGroup_e4a3d54d',
    isExpanded: 'isExpanded_e4a3d54d',
    propertyPaneGroupContent: 'propertyPaneGroupContent_e4a3d54d',
    propertyPaneGroupHeaderText: 'propertyPaneGroupHeaderText_e4a3d54d',
    propertyPaneGroupHeaderIcon: 'propertyPaneGroupHeaderIcon_e4a3d54d',
    propertyPaneGroupHeaderWithAccordion: 'propertyPaneGroupHeaderWithAccordion_e4a3d54d',
    propertyPaneGroupHeaderNoAccordion: 'propertyPaneGroupHeaderNoAccordion_e4a3d54d',
    propertyPaneChoiceGroup: 'propertyPaneChoiceGroup_e4a3d54d',
    propertyPaneGroupField: 'propertyPaneGroupField_e4a3d54d',
};
exports.default = styles;
...
// module
exports.push([module.i, ".propertyPaneGroupHeader_e4a3d54d{background:0 0;border-top:1px solid;border-top-color:\"[theme:neutralLight, default: #eaeaea]\";color:\"[theme:neutralPrimary, default: #333333]\";cursor:pointer;font-weight:600;font-size:14px;height:40px;line-height:40px;width:100%;padding:0 8px}[dir=ltr] .propertyPaneGroupHeader_e4a3d54d{text-align:left}[dir=rtl] .propertyPaneGroupHeader_e4a3d54d{text-align:right}.propertyPaneGroup_e4a3d54d:last-child .propertyPaneGroupHeader_e4a3d54d{border-bottom:1px solid;border-bottom-color:\"[theme:neutralLight, default: #eaeaea]\"}.propertyPaneGroupHeader_e4a3d54d .ms-Icon{color:\"[theme:neutralSecondaryAlt, default: #767676]\";font-size:14px;line-height:38px;position:relative}[dir=ltr] .propertyPaneGroupHeader_e4a3d54d .ms-Icon{padding-right:4px}[dir=rtl] .propertyPaneGroupHeader_e4a3d54d .ms-Icon{padding-left:4px}.propertyPaneGroup_e4a3d54d.isExpanded_e4a3d54d .propertyPaneGroupContent_e4a3d54d{display:block}.propertyPaneGroupHeaderText_e4a3d54d{vertical-align:top;line-height:38px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap}[dir=ltr] .propertyPaneGroupHeaderText_e4a3d54d{margin-right:20}[dir=rtl] .propertyPaneGroupHeaderText_e4a3d54d{margin-left:20}[dir=ltr] .propertyPaneGroupHeaderIcon_e4a3d54d{float:left}[dir=rtl] .propertyPaneGroupHeaderIcon_e4a3d54d{float:right}.propertyPaneGroupHeader_e4a3d54d{border-bottom:1px solid;border-bottom-color:\"[theme:neutralLight, default: #eaeaea]\"}[dir=ltr] .propertyPaneGroupHeader_e4a3d54d{border-right-width:1px}[dir=rtl] .propertyPaneGroupHeader_e4a3d54d{border-left-width:1px}[dir=ltr] .propertyPaneGroupHeader_e4a3d54d{border-right-style:solid}[dir=rtl] .propertyPaneGroupHeader_e4a3d54d{border-left-style:solid}[dir=ltr] .propertyPaneGroupHeader_e4a3d54d{border-right-color:\"[theme:neutralLight, default: #eaeaea]\"}[dir=rtl] .propertyPaneGroupHeader_e4a3d54d{border-left-color:\"[theme:neutralLight, default: #eaeaea]\"}.propertyPaneGroupHeaderWithAccordion_e4a3d54d{padding:4px 0}.propertyPaneGroupHeaderNoAccordion_e4a3d54d{color:\"[theme:neutralPrimary, default: #333333]\";font-weight:600;font-size:14px;height:40px;line-height:40px;padding-top:4px;width:300px;text-overflow:ellipsis;overflow:hidden}[dir=ltr] .propertyPaneGroupHeaderNoAccordion_e4a3d54d{padding-right:0}[dir=rtl] .propertyPaneGroupHeaderNoAccordion_e4a3d54d{padding-left:0}[dir=ltr] .propertyPaneGroupHeaderNoAccordion_e4a3d54d{padding-left:20px}[dir=rtl] .propertyPaneGroupHeaderNoAccordion_e4a3d54d{padding-right:20px}[dir=ltr] .propertyPaneGroupHeaderNoAccordion_e4a3d54d{text-align:left}[dir=rtl] .propertyPaneGroupHeaderNoAccordion_e4a3d54d{text-align:right}.propertyPaneGroupContent_e4a3d54d{padding:0 20px 16px}.propertyPaneGroupContent_e4a3d54d h2{font-size:15px;color:\"[theme:neutralPrimary, default: #333333]\";font-weight:600;font-weight:400}.propertyPaneGroupContent_e4a3d54d .ms-TextField.ms-TextField--multiline .ms-TextField-field{resize:vertical}.propertyPaneChoiceGroup_e4a3d54d .ms-Label{width:100%;box-sizing:border-box}.propertyPaneChoiceGroup_e4a3d54d .ms-ChoiceField--icon,.propertyPaneChoiceGroup_e4a3d54d .ms-ChoiceField--image{height:100%;width:calc(33.33% - 4px)}.propertyPaneChoiceGroup_e4a3d54d .ms-ChoiceField--icon .ms-ChoiceField-field,.propertyPaneChoiceGroup_e4a3d54d .ms-ChoiceField--image .ms-ChoiceField-field{min-width:100%}.propertyPaneChoiceGroup_e4a3d54d .ms-ChoiceField--icon .ms-ChoiceField-innerField,.propertyPaneChoiceGroup_e4a3d54d .ms-ChoiceField--image .ms-ChoiceField-innerField{-webkit-box-align:center;-ms-flex-align:center;align-items:center;display:-webkit-box;display:-ms-flexbox;display:flex;height:52px;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;padding:0}.propertyPaneChoiceGroup_e4a3d54d .ms-ChoiceField--icon .ms-ChoiceField-labelWrapper,.propertyPaneChoiceGroup_e4a3d54d .ms-ChoiceField--image .ms-ChoiceField-labelWrapper{margin-bottom:8px}.propertyPaneChoiceGroup_e4a3d54d .themeableSvgPath{fill:\"[theme:neutralPrimary, default: #333333]\"}.propertyPaneChoiceGroup_e4a3d54d .ms-ChoiceField--title .ms-Label,.propertyPaneGroupField_e4a3d54d{color:\"[theme:neutralPrimary, default: #333333]\"}.propertyPaneGroupField_e4a3d54d{padding-top:4px;word-wrap:break-word}.propertyPaneGroupField_e4a3d54d a.ms-Link{font-size:14px;margin-bottom:16px}@media screen and (-ms-high-contrast:active){.propertyPaneGroupField_e4a3d54d a.ms-Link:hover{text-decoration:underline}}@media screen and (-ms-high-contrast:white-on-black){.propertyPaneGroupField_e4a3d54d a.ms-Link{color:#ff0}}", ""]);
...
var styles = {
    root: 'root_33246d0a',
    imageRoot: 'imageRoot_33246d0a',
    image: 'image_33246d0a',
    imageIsLoaded: 'imageIsLoaded_33246d0a',
    field: 'field_33246d0a',
    fieldIsChecked: 'fieldIsChecked_33246d0a',
    fieldIsDisabled: 'fieldIsDisabled_33246d0a',
    fieldIsImage: 'fieldIsImage_33246d0a',
    fieldIsIcon: 'fieldIsIcon_33246d0a',
    innerField: 'innerField_33246d0a',
    imageWrapper: 'imageWrapper_33246d0a',
    imageWrapperIsHidden: 'imageWrapperIsHidden_33246d0a',
    labelWrapper: 'labelWrapper_33246d0a',
    choiceFieldIsIcon: 'choiceFieldIsIcon_33246d0a',
    iconWrapper: 'iconWrapper_33246d0a',
    choiceFieldIsInFocus: 'choiceFieldIsInFocus_33246d0a',
    choiceFieldIsImage: 'choiceFieldIsImage_33246d0a',
};
exports.default = styles;
...
// module
exports.push([module.i, ".root_33246d0a{display:block}.imageRoot_33246d0a{overflow:hidden}.image_33246d0a{display:block;opacity:0}.image_33246d0a.imageIsLoaded_33246d0a{opacity:1}.field_33246d0a:before{display:inline-block;background-color:\"[theme:white, default: #ffffff]\";border:1px solid;width:20px;height:20px;font-weight:400;top:-1px;transition-property:border-color;transition-duration:.2s;transition-timing-function:cubic-bezier(.4,0,.23,1);border-radius:50%}.field_33246d0a:after,.field_33246d0a:before{content:\"\";position:absolute;box-sizing:border-box}.field_33246d0a:after{width:0;height:0;border-radius:50%;transition-property:border-width;transition-duration:.15s;transition-timing-function:cubic-bezier(.4,0,.23,1)}[dir=ltr] .field_33246d0a:after{left:10px}[dir=rtl] .field_33246d0a:after{right:10px}[dir=ltr] .field_33246d0a:after{right:0}[dir=rtl] .field_33246d0a:after{left:0}.field_33246d0a{display:inline-block;cursor:pointer;margin-top:0;position:relative;vertical-align:top;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.field_33246d0a:focus:before,.field_33246d0a:hover:before{border-color:\"[theme:neutralPrimary, default: #333333]\"}.field_33246d0a.fieldIsChecked_33246d0a:before{border:2px solid;border-color:\"[theme:themePrimary, default: #0078d7]\"}@media screen and (-ms-high-contrast:active){.field_33246d0a.fieldIsChecked_33246d0a:before{border-color:#1aebff}}@media screen and (-ms-high-contrast:black-on-white){.field_33246d0a.fieldIsChecked_33246d0a:before{border-color:#37006e}}.field_33246d0a.fieldIsChecked_33246d0a:after{border:5px solid;border-color:\"[theme:themePrimary, default: #0078d7]\";top:4px;width:10px;height:10px}[dir=ltr] .field_33246d0a.fieldIsChecked_33246d0a:after{left:5px}[dir=rtl] .field_33246d0a.fieldIsChecked_33246d0a:after{right:5px}@media screen and (-ms-high-contrast:active){.field_33246d0a.fieldIsChecked_33246d0a:after{border-color:#1aebff}}@media screen and (-ms-high-contrast:black-on-white){.field_33246d0a.fieldIsChecked_33246d0a:after{border-color:#37006e}}.field_33246d0a.fieldIsChecked_33246d0a:focus:before,.field_33246d0a.fieldIsChecked_33246d0a:hover:before{border-color:\"[theme:themeDarkAlt, default: #106ebe]\"}.field_33246d0a.fieldIsDisabled_33246d0a{cursor:default}.field_33246d0a.fieldIsDisabled_33246d0a:before{background-color:\"[theme:neutralTertiaryAlt, default: #c8c8c8]\";border-color:\"[theme:neutralTertiaryAlt, default: #c8c8c8]\"}@media screen and (-ms-high-contrast:active){.field_33246d0a.fieldIsDisabled_33246d0a:before{border-color:#0f0}}@media screen and (-ms-high-contrast:black-on-white){.field_33246d0a.fieldIsDisabled_33246d0a:before{border-color:#600000}}.field_33246d0a.fieldIsDisabled_33246d0a .ms-Label{color:\"[theme:neutralTertiaryAlt, default: #c8c8c8]\"}@media screen and (-ms-high-contrast:active){.field_33246d0a.fieldIsDisabled_33246d0a .ms-Label{color:#0f0}}@media screen and (-ms-high-contrast:black-on-white){.field_33246d0a.fieldIsDisabled_33246d0a .ms-Label{color:#600000}}.field_33246d0a.fieldIsChecked_33246d0a.fieldIsDisabled_33246d0a:before{background-color:\"[theme:white, default: #ffffff]\";border-color:\"[theme:neutralTertiaryAlt, default: #c8c8c8]\"}.field_33246d0a.fieldIsChecked_33246d0a.fieldIsDisabled_33246d0a:after{background-color:\"[theme:neutralTertiaryAlt, default: #c8c8c8]\"}.fieldIsIcon_33246d0a,.fieldIsImage_33246d0a{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;font-size:0;margin:0 4px 4px 0;background-color:\"[theme:neutralLighter, default: #f4f4f4]\";display:inline-block;box-sizing:border-box;min-width:96px;cursor:pointer;padding:4px;padding-top:22px;margin:0;text-align:center;transition:all .2s ease;border:2px solid transparent}[dir=rtl] .fieldIsIcon_33246d0a,[dir=rtl] .fieldIsImage_33246d0a{margin:0 0 4px 4px}[dir=ltr] .fieldIsIcon_33246d0a,[dir=ltr] .fieldIsImage_33246d0a{padding-left:0}[dir=rtl] .fieldIsIcon_33246d0a,[dir=rtl] .fieldIsImage_33246d0a{padding-right:0}.fieldIsIcon_33246d0a.fieldIsDisabled_33246d0a,.fieldIsImage_33246d0a.fieldIsDisabled_33246d0a{cursor:default}.fieldIsIcon_33246d0a.fieldIsDisabled_33246d0a .innerField_33246d0a,.fieldIsImage_33246d0a.fieldIsDisabled_33246d0a .innerField_33246d0a{opacity:.25}.fieldIsIcon_33246d0a .innerField_33246d0a,.fieldIsImage_33246d0a .innerField_33246d0a{position:relative;padding:0 28px}.fieldIsIcon_33246d0a .innerField_33246d0a .imageWrapper_33246d0a,.fieldIsImage_33246d0a .innerField_33246d0a .imageWrapper_33246d0a{padding-bottom:2px}.fieldIsIcon_33246d0a .innerField_33246d0a .imageWrapper_33246d0a.imageWrapperIsHidden_33246d0a,.fieldIsImage_33246d0a .innerField_33246d0a .imageWrapper_33246d0a.imageWrapperIsHidden_33246d0a{position:absolute;left:0;top:0;width:100%;height:100%;overflow:hidden;opacity:0}.fieldIsIcon_33246d0a .innerField_33246d0a .imageWrapper_33246d0a .ms-Image,.fieldIsImage_33246d0a .innerField_33246d0a .imageWrapper_33246d0a .ms-Image{display:inline-block}.fieldIsIcon_33246d0a .labelWrapper_33246d0a,.fieldIsImage_33246d0a .labelWrapper_33246d0a{display:block;position:relative;margin:4px 0 0;height:32px;line-height:16px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;font-size:14px;font-weight:400}.fieldIsIcon_33246d0a .labelWrapper_33246d0a .ms-Label,.fieldIsImage_33246d0a .labelWrapper_33246d0a .ms-Label{padding:0}.fieldIsIcon_33246d0a:before,.fieldIsImage_33246d0a:before{top:3px;left:auto!important;opacity:0}[dir=ltr] .fieldIsIcon_33246d0a:before,[dir=ltr] .fieldIsImage_33246d0a:before{right:3px}[dir=rtl] .fieldIsIcon_33246d0a:before,[dir=rtl] .fieldIsImage_33246d0a:before{left:3px}.fieldIsIcon_33246d0a:after,.fieldIsImage_33246d0a:after{top:13px;left:auto!important}[dir=ltr] .fieldIsIcon_33246d0a:after,[dir=ltr] .fieldIsImage_33246d0a:after{right:13px}[dir=rtl] .fieldIsIcon_33246d0a:after,[dir=rtl] .fieldIsImage_33246d0a:after{left:13px}.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a):focus,.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a):hover,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a):focus,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a):hover{border-color:\"[theme:neutralTertiaryAlt, default: #c8c8c8]\"}.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a):focus:before,.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a):hover:before,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a):focus:before,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a):hover:before{opacity:1}.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a{border-color:\"[theme:themePrimary, default: #0078d7]\"}.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:before,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:before{opacity:1}.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:after,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:after{top:8px}[dir=ltr] .fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:after,[dir=ltr] .fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:after{right:8px}[dir=rtl] .fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:after,[dir=rtl] .fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:after{left:8px}.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:focus,.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:focus:before,.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:hover,.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:hover:before,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:focus,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:focus:before,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:hover,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:hover:before{border-color:\"[theme:themeDark, default: #005a9e]\"}.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:focus:after,.fieldIsIcon_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:hover:after,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:focus:after,.fieldIsImage_33246d0a:not(.fieldIsDisabled_33246d0a).fieldIsChecked_33246d0a:hover:after{background-color:\"[theme:themeDark, default: #005a9e]\"}.choiceFieldIsIcon_33246d0a{height:96px;width:96px}.choiceFieldIsIcon_33246d0a .iconWrapper_33246d0a{font-size:32px;line-height:32px;height:32px}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a::-moz-focus-inner{border:0}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a{outline:transparent;position:relative}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a:after{content:\"\";position:absolute;top:1px;right:1px;bottom:1px;left:1px;pointer-events:none;border:1px solid}@media screen and (-ms-high-contrast:active){.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a::-moz-focus-inner{border:0}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a{outline:transparent;position:relative}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a:after{content:\"\";position:absolute;top:1px;right:1px;bottom:1px;left:1px;pointer-events:none;border:2px solid}}@media screen and (-ms-high-contrast:black-on-white){.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a::-moz-focus-inner{border:0}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a{outline:transparent;position:relative}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a:after{content:\"\";position:absolute;top:1px;right:1px;bottom:1px;left:1px;pointer-events:none;border:2px solid}}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsIcon_33246d0a::-moz-focus-inner,.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsImage_33246d0a::-moz-focus-inner{border:0}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsIcon_33246d0a,.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsImage_33246d0a{outline:transparent;position:relative}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsIcon_33246d0a:after,.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsImage_33246d0a:after{content:\"\";position:absolute;top:0;right:0;bottom:0;left:0;pointer-events:none;border:1px solid}@media screen and (-ms-high-contrast:active){.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsIcon_33246d0a::-moz-focus-inner,.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsImage_33246d0a::-moz-focus-inner{border:0}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsIcon_33246d0a,.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsImage_33246d0a{outline:transparent;position:relative}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsIcon_33246d0a:after,.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsImage_33246d0a:after{content:\"\";position:absolute;top:1px;right:1px;bottom:1px;left:1px;pointer-events:none;border:2px solid}}@media screen and (-ms-high-contrast:black-on-white){.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsIcon_33246d0a::-moz-focus-inner,.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsImage_33246d0a::-moz-focus-inner{border:0}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsIcon_33246d0a,.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsImage_33246d0a{outline:transparent;position:relative}.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsIcon_33246d0a:after,.ms-Fabric.is-focusVisible .choiceFieldIsInFocus_33246d0a.choiceFieldIsImage_33246d0a:after{content:\"\";position:absolute;top:1px;right:1px;bottom:1px;left:1px;pointer-events:none;border:3px solid}}", ""]);
...
// module
exports.push([module.i, ".propertyPaneTitleBarBox_50ae0471{position:absolute;width:100%;top:0;padding-bottom:20px}.propertyPaneTitleBar_50ae0471{background:#3c3c3c;padding:10px 20px 12px;height:25px}.propertyPanePageTitle_50ae0471{line-height:1.2}[dir=ltr] .propertyPanePageTitle_50ae0471{margin-right:20px}[dir=rtl] .propertyPanePageTitle_50ae0471{margin-left:20px}.propertyPaneClose_50ae0471{background-color:transparent;border:none;color:#fff;cursor:pointer;font-size:20px;padding:0 20px;position:absolute;top:13px;min-width:0}[dir=ltr] .propertyPaneClose_50ae0471{right:0}[dir=rtl] .propertyPaneClose_50ae0471{left:0}.propertyPanePageContent_50ae0471{position:absolute;width:100%;top:67px;bottom:0;overflow-x:hidden;overflow-y:auto}.propertyPanePageDescription_50ae0471{padding:0 20px 16px;color:\"[theme:neutralPrimary, default: #333333]\";font-size:14px}", ""]);
...
var Strings_resx_1 = __webpack_require__(17);
var PropertyPane_module_scss_1 = __webpack_require__(74);
var PropertyPaneTitleBar_module_scss_1 = __webpack_require__(90);
...
// module
exports.push([module.i, ".propertyPane_3e42eabf{top:0;bottom:0;position:absolute;background-color:\"[theme:primaryBackground, default: #ffffff]\";width:340px;-webkit-font-smoothing:antialiased;max-width:100%}[dir=ltr] .propertyPane_3e42eabf{border-left-width:1px}[dir=rtl] .propertyPane_3e42eabf{border-right-width:1px}[dir=ltr] .propertyPane_3e42eabf{border-left-style:solid}[dir=rtl] .propertyPane_3e42eabf{border-right-style:solid}[dir=ltr] .propertyPane_3e42eabf{border-left-color:\"[theme:neutralLight, default: #eaeaea]\"}[dir=rtl] .propertyPane_3e42eabf{border-right-color:\"[theme:neutralLight, default: #eaeaea]\"}[dir=ltr] .propertyPane_3e42eabf{right:0}[dir=rtl] .propertyPane_3e42eabf{left:0}.propertyPaneDescription_3e42eabf{padding:0 20px;color:\"[theme:neutralPrimary, default: #333333]\";font-size:14px}.propertyPaneScreenReaderOnly_3e42eabf{position:absolute;text-indent:-9999px;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;border:0}.twoRowFooter_3e42eabf{bottom:125px}.oneRowFooter_3e42eabf{bottom:72px}.overlay_3e42eabf{height:100%;width:340px;z-index:1}.spinner_3e42eabf{top:50%;position:relative}", ""]);
...
var styles = {
    propertyPaneTitleBarBox: 'propertyPaneTitleBarBox_969ad5cd',
    propertyPaneTitleBar: 'propertyPaneTitleBar_969ad5cd',
    propertyPanePageTitle: 'propertyPanePageTitle_969ad5cd',
    propertyPaneClose: 'propertyPaneClose_969ad5cd',
};
exports.default = styles;
...
// module
exports.push([module.i, ".propertyPaneTitleBarBox_969ad5cd{position:absolute;width:100%;top:0;padding-bottom:20px}.propertyPaneTitleBar_969ad5cd{background:#3c3c3c;padding:10px 20px 12px;height:25px}.propertyPanePageTitle_969ad5cd{line-height:1.2}[dir=ltr] .propertyPanePageTitle_969ad5cd{margin-right:20px}[dir=rtl] .propertyPanePageTitle_969ad5cd{margin-left:20px}.propertyPaneClose_969ad5cd{background-color:transparent;border:none;color:#fff;cursor:pointer;font-size:20px;padding:0 20px;position:absolute;top:13px;min-width:0}[dir=ltr] .propertyPaneClose_969ad5cd{right:0}[dir=rtl] .propertyPaneClose_969ad5cd{left:0}", ""]);
...
var office_ui_fabric_react_1 = __webpack_require__(8);
var Strings_resx_1 = __webpack_require__(17);
var PropertyPaneFooter_module_scss_1 = __webpack_require__(94);
var PropertyPane_1 = __webpack_require__(71);
...
var styles = {
    propertyPaneFooter: 'propertyPaneFooter_b33e6856',
    propertyPaneCommandButtonsBox: 'propertyPaneCommandButtonsBox_b33e6856',
    propertyPanePageNav: 'propertyPanePageNav_b33e6856',
    propertyPaneBackNavLink: 'propertyPaneBackNavLink_b33e6856',
    propertyPaneNextNavLink: 'propertyPaneNextNavLink_b33e6856',
    propertyPaneBackArrow: 'propertyPaneBackArrow_b33e6856',
    propertyPaneNextArrow: 'propertyPaneNextArrow_b33e6856',
    propertyPanePageOfPages: 'propertyPanePageOfPages_b33e6856',
};
exports.default = styles;
...
// module
exports.push([module.i, ".propertyPaneFooter_b33e6856{background-color:\"[theme:primaryBackground, default: #ffffff]\";position:absolute;bottom:0;left:0;padding:20px;right:0}.propertyPaneCommandButtonsBox_b33e6856{padding-bottom:20px}.propertyPanePageNav_b33e6856{-webkit-box-align:baseline;-ms-flex-align:baseline;align-items:baseline;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between}.propertyPaneBackNavLink_b33e6856,.propertyPaneNextNavLink_b33e6856{background-color:transparent;border:0;color:\"[theme:neutralPrimary, default: #333333]\";font-size:14px;font-weight:400;height:32px;outline:0;padding:0}.propertyPaneBackNavLink_b33e6856 .propertyPaneBackArrow_b33e6856,.propertyPaneBackNavLink_b33e6856 .propertyPaneNextArrow_b33e6856,.propertyPaneNextNavLink_b33e6856 .propertyPaneBackArrow_b33e6856,.propertyPaneNextNavLink_b33e6856 .propertyPaneNextArrow_b33e6856{color:\"[theme:themePrimary, default: #0078d7]\";position:relative;top:2px}[dir=ltr] .propertyPaneBackNavLink_b33e6856 .propertyPaneBackArrow_b33e6856,[dir=ltr] .propertyPaneNextNavLink_b33e6856 .propertyPaneBackArrow_b33e6856{margin-right:4px}[dir=ltr] .propertyPaneBackNavLink_b33e6856 .propertyPaneNextArrow_b33e6856,[dir=ltr] .propertyPaneNextNavLink_b33e6856 .propertyPaneNextArrow_b33e6856,[dir=rtl] .propertyPaneBackNavLink_b33e6856 .propertyPaneBackArrow_b33e6856,[dir=rtl] .propertyPaneNextNavLink_b33e6856 .propertyPaneBackArrow_b33e6856{margin-left:4px}[dir=rtl] .propertyPaneBackNavLink_b33e6856 .propertyPaneNextArrow_b33e6856,[dir=rtl] .propertyPaneNextNavLink_b33e6856 .propertyPaneNextArrow_b33e6856{margin-right:4px}.propertyPaneBackNavLink_b33e6856:disabled,.propertyPaneBackNavLink_b33e6856:disabled .propertyPaneBackArrow_b33e6856,.propertyPaneBackNavLink_b33e6856:disabled .propertyPaneNextArrow_b33e6856,.propertyPaneNextNavLink_b33e6856:disabled,.propertyPaneNextNavLink_b33e6856:disabled .propertyPaneBackArrow_b33e6856,.propertyPaneNextNavLink_b33e6856:disabled .propertyPaneNextArrow_b33e6856{color:\"[theme:neutralTertiary, default: #a6a6a6]\"}.propertyPaneBackNavLink_b33e6856:not(:disabled):active,.propertyPaneBackNavLink_b33e6856:not(:disabled):focus,.propertyPaneBackNavLink_b33e6856:not(:disabled):hover,.propertyPaneNextNavLink_b33e6856:not(:disabled):active,.propertyPaneNextNavLink_b33e6856:not(:disabled):focus,.propertyPaneNextNavLink_b33e6856:not(:disabled):hover{background-color:\"[theme:themeLight, default: #c7e0f4]\";color:\"[theme:themePrimary, default: #0078d7]\";cursor:pointer}.propertyPaneBackNavLink_b33e6856:not(:disabled):active .propertyPaneBackArrow_b33e6856,.propertyPaneBackNavLink_b33e6856:not(:disabled):active .propertyPaneNextArrow_b33e6856,.propertyPaneBackNavLink_b33e6856:not(:disabled):focus .propertyPaneBackArrow_b33e6856,.propertyPaneBackNavLink_b33e6856:not(:disabled):focus .propertyPaneNextArrow_b33e6856,.propertyPaneBackNavLink_b33e6856:not(:disabled):hover .propertyPaneBackArrow_b33e6856,.propertyPaneBackNavLink_b33e6856:not(:disabled):hover .propertyPaneNextArrow_b33e6856,.propertyPaneNextNavLink_b33e6856:not(:disabled):active .propertyPaneBackArrow_b33e6856,.propertyPaneNextNavLink_b33e6856:not(:disabled):active .propertyPaneNextArrow_b33e6856,.propertyPaneNextNavLink_b33e6856:not(:disabled):focus .propertyPaneBackArrow_b33e6856,.propertyPaneNextNavLink_b33e6856:not(:disabled):focus .propertyPaneNextArrow_b33e6856,.propertyPaneNextNavLink_b33e6856:not(:disabled):hover .propertyPaneBackArrow_b33e6856,.propertyPaneNextNavLink_b33e6856:not(:disabled):hover .propertyPaneNextArrow_b33e6856{color:\"[theme:themeDark, default: #005a9e]\"}.propertyPanePageOfPages_b33e6856{margin-top:6px}", ""]);
...
//# sourceMappingURL=0.sp-webpart-base-propertypane_8c73df6f1cb13f2c573d.js.map