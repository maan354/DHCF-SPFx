    ...
    CalloutBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'ms-CalloutExample' },
            React.createElement("div", { className: 'ms-CalloutBasicExample-buttonArea', ref: function (menuButton) { return _this._menuButtonElement = menuButton; } },
                React.createElement(Button_1.Button, { onClick: this._onShowMenuClicked }, isCalloutVisible ? 'Hide callout' : 'Show callout')),
            isCalloutVisible && (React.createElement(Callout_1.Callout, { className: 'ms-CalloutExample-callout', gapSpace: 0, targetElement: this._menuButtonElement, onDismiss: this._onCalloutDismiss, setInitialFocus: true },
