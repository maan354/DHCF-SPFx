...
var PanelNonModalExample = (function (_super) {
    ...
    PanelNonModalExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Button_1.Button, { description: 'Opens the Sample Panel', onClick: this._showPanel.bind(this) }, "Open Panel"),
            React.createElement(Panel_1.Panel, { isBlocking: false, isOpen: this.state.showPanel, onDismiss: this._closePanel.bind(this), type: Panel_1.PanelType.medium, headerText: 'Non-Modal Panel', closeButtonAriaLabel: 'Close' },
