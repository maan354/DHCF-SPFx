...
var ContextualMenuCustomizationExample = (function (_super) {
    ...
    ContextualMenuCustomizationExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Button_1.Button, { onClick: this._onClick, className: 'ContextualMenuButton3' }, " Click for ContextualMenu "),
    ...
    ContextualMenuCustomizationExample.prototype._renderCharmMenuItem = function (item) {
        return React.createElement(Button_1.Button, { buttonType: Button_1.ButtonType.icon, icon: item.name, className: 'ms-ContextualMenu-customizationExample-icon ms-ContextualMenu-link', "data-is-focusable": true });
    };
