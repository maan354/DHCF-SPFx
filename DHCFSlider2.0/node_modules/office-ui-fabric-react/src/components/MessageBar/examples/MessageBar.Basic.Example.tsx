...
export const MessageBarBasicExample = () => (
  <div className='ms-BasicMessageBarsExample'>
    ...
    <MessageBar
      ...
      actions={ <div><Button>Yes</Button><Button>No</Button></div> }>SevereWarning - lorem ipsum dolor sit amet, a elit sem interdum consectetur adipiscing elit. <Link href='www.bing.com'>Visit our website</Link></MessageBar>
