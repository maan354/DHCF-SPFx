    ...
    var PanelSmallRightExample = (function (_super) {
        ...
        PanelSmallRightExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                React.createElement(Button_1.Button, { description: 'Opens the Sample Panel', onClick: this._onShowPanel }, "Open Panel"),
                React.createElement(Panel_1.Panel, { isOpen: this.state.showPanel, type: Panel_1.PanelType.smallFixedFar, onDismiss: this._onClosePanel, headerText: 'Panel - Small, right-aligned, fixed, with footer', onRenderFooterContent: function () {
                        return (React.createElement("div", null,
