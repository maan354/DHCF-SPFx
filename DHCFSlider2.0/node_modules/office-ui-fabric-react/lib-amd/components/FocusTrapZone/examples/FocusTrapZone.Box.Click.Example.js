...
define(["require", "exports", "react", "react-dom", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/FocusTrapZone", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/TextField", "office-ui-fabric-react/lib/Toggle", "./FocusTrapZone.Box.Example.scss"], function (require, exports, React, ReactDOM, Button_1, FocusTrapZone_1, Link_1, TextField_1, Toggle_1) {
    "use strict";
    ...
    var BoxNoClickExample = (function (_super) {
        ...
        BoxNoClickExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                React.createElement(Button_1.Button, { description: 'Focuses inside the FocusTrapZone', onClick: this._onButtonClickHandler.bind(this) }, "Go to Trap Zone"),
                (function () {
                    if (isToggled) {
        ...
        BoxNoClickExample.prototype._internalContents = function () {
            ...
            return (React.createElement("div", { className: 'ms-FocusTrapZoneBoxExample' },
                ...
                React.createElement("br", null),
                React.createElement(Toggle_1.Toggle, { ref: 'toggle', checked: isToggled, onChanged: this._onFocusTrapZoneToggleChanged.bind(this), label: 'Focus Trap Zone', onText: 'On', offText: 'Off' }),
                (function () {
                    if (isToggled) {
                        return (React.createElement(Button_1.Button, { description: 'Exit Focus Trap Zone', onClick: _this._onExitButtonClickHandler.bind(_this) }, "Exit Focus Trap Zone"));
                    }
                })()));
        };
