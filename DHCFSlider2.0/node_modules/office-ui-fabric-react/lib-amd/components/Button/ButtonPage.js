...
define(["require", "exports", "react", "@uifabric/example-app-base", "office-ui-fabric-react/lib/Checkbox", "./examples/Button.Default.Example", "./examples/Button.ContextualMenu.Example", "./examples/Button.Primary.Example", "./examples/Button.Compound.Example", "./examples/Button.Command.Example", "./examples/Button.Icon.Example", "./examples/Button.Anchor.Example", "./examples/Button.ScreenReader.Example", "./examples/Button.Basic.Example.scss"], function (require, exports, React, example_app_base_1, Checkbox_1, Button_Default_Example_1, Button_ContextualMenu_Example_1, Button_Primary_Example_1, Button_Compound_Example_1, Button_Command_Example_1, Button_Icon_Example_1, Button_Anchor_Example_1, Button_ScreenReader_Example_1) {
    "use strict";
