...
define(["require", "exports", "react", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/TextField", "office-ui-fabric-react/lib/DetailsList", "office-ui-fabric-react/lib/MarqueeSelection", "@uifabric/example-app-base"], function (require, exports, React, Link_1, TextField_1, DetailsList_1, MarqueeSelection_1, example_app_base_1) {
    "use strict";
        ...
        DetailsListBasicExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                ...
                React.createElement(MarqueeSelection_1.MarqueeSelection, { selection: this._selection },
                    React.createElement(DetailsList_1.DetailsList, { items: items, setKey: 'set', selection: this._selection, selectionPreservedOnEmptyClick: true, onItemInvoked: function (item) { return alert("Item invoked: " + item.name); }, onRenderItemColumn: this._onRenderItemColumn }))));
        };
