...
define(["require", "exports", "react", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/Callout", "office-ui-fabric-react/lib/CommandBar", "./CalloutExample.scss"], function (require, exports, React, Button_1, Callout_1, CommandBar_1) {
    "use strict";
        ...
        CalloutNestedExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: 'ms-CalloutExample' },
                React.createElement("div", { className: 'ms-CalloutBasicExample-buttonArea', ref: function (menuButton) { return _this._menuButtonElement = menuButton; } },
                    React.createElement(Button_1.Button, { onClick: this._onDismiss }, isCalloutVisible ? 'Hide callout' : 'Show callout')),
                isCalloutVisible ? (React.createElement("div", null,
                    React.createElement(Callout_1.Callout, { className: 'ms-CalloutExample-callout', gapSpace: 0, targetElement: this._menuButtonElement, onDismiss: function (ev) { _this._onDismiss(ev); }, setInitialFocus: true },
